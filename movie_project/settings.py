...
SECRET_KEY = 'b)h6^^-nie!84hdk104ea_@p&z-upksjq0ywx4ygh%i_70_(^v'
...
MIDDLEWARE = [
    ...
    'movies.middleware.AutoLogoutMiddleware',
]
...
DATABASES = {
    'default': {
        'ENGINE': HideSettings.engine,
        'NAME': HideSettings.name,
        'USER': HideSettings.user,
        'PASSWORD': HideSettings.password,
        'HOST': HideSettings.host,
        'PORT': HideSettings.port,
    }
}
